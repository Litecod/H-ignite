...
const LoginPage = () => {
  return (
    <div className="w-full h-[28rem] md:h-auto">
      <div className="flex flex-col w-[100%] md:w-[65%] lg:w-[40%] xl:w-[25%] mx-auto gap-10 md:border-[3px] md:border-[#E2E1E1] px-[0.8rem] md:px-[1.5rem] md:py-[1.5rem] mt-[2rem] md:mt-[5rem]">
